		...
		<tbody>
			<tr style="vertical-align: top;" valign="top">
				<td style="word-break: break-word; vertical-align: top;" valign="top">
										...
										<div
											...
											<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
												...
												<div
													...
													<p
														...
														<span style="font-size: 22px;">Hello <strong>Username</strong> (usermail@gmail.com)</span></p>
												...
												<div
													...
													<p
														...
														<span style="font-size: 16px;"><span style="font-size: 16px;">We recieved your message: <span
																style="color: #10bbaa; font-size: 16px;">TestUsername</span></span>
													</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div
												...
												<div
													...
													<span style="font-size: 16px;">We will get back to you on: <strong>+91 88888 88888</strong> </p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<!--[if (!mso)&(!IE)]><!-->
					...
					<div
						style="background-image:url('images/bg_footer.jpg');background-position:top center;background-repeat:no-repeat;background-color:transparent;">
