		...
		<tbody>
			<tr style="vertical-align: top;" valign="top">
				<td style="word-break: break-word; vertical-align: top;" valign="top">
					...
					<div style="background-color:transparent;">
						<div class="block-grid"
							style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #10abba;">
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:#10abba;">
								<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:#10abba"><![endif]-->
								<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color:#10abba;width:600px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 20px; padding-top:5px; padding-bottom:5px;"><![endif]-->
								<div class="col num12"
									style="min-width: 320px; max-width: 600px; display: table-cell; vertical-align: top; width: 600px;">
									<div style="width:100% !important;">
										<!--[if (!mso)&(!IE)]><!-->
										<div
											...
											<div align="left" class="img-container left fixedwidth"
												...
												<div style="font-size:1px;line-height:25px"> </div><img
													alt="iFCast Consultancy" border="0" class="left fixedwidth"
													src="<?php echo base_url(); ?>assets/images/email/logo_1.png"
										...
										<div
											...
											<div align="center" class="img-container center fixedwidth"
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
													...
													src="illo.png"
													style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 60%; max-width: 530px; display: block;"
											...
											<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
												...
												<div
													...
													<p
														...
														<span style="font-size: 22px;">Hello <strong><?php echo $userfullname; ?></strong> (<?php echo $useremailid; ?>)</span></p>
											...
											<div
												...
												<div
													...
													<p
														...
														<span style="font-size: 16px;"><span style="font-size: 16px;">We recieved your message: <span
																style="color: #10bbaa; font-size: 16px;"><?php echo $message; ?></span></span>
													</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div
												...
												<div
													...
													<p
													style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin: 0;">
													<span style="font-size: 16px;">We will get back to you on: <strong><?php echo $phoneno; ?></strong> </p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<!--[if (!mso)&(!IE)]><!-->
					...
					<div
						style="background-image:url('<?php echo base_url(); ?>assets/images/email/bg_footer.jpg');background-position:top center;background-repeat:no-repeat;background-color:transparent;">
						<div class="block-grid no-stack"
							style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
							<div
								style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
								<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('<?php echo base_url(); ?>assets/images/email/bg_password.gif');background-position:top center;background-repeat:no-repeat;background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
								...
								<div class="col num12"
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div
												style="color:#555555;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
												<div
													style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
													<p
														style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin: 0;">
														<span style="font-size: 16px;">Thank you for getting in touch with us! <br><span
																style="color: #132f40; font-size: 16px;"><br><strong>Now, Get going with our iFCast Job Portal</strong></span></span></p>
													<p
														style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin: 0;">
														<span style="font-size: 16px;">you just need to upload your resume.</span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<div align="left" class="button-container"
												style="padding-top:5px;padding-right:10px;padding-bottom:35px;padding-left:10px;">
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 5px; padding-right: 10px; padding-bottom: 35px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:31.5pt; width:186pt; v-text-anchor:middle;" arcsize="120%" stroke="false" fillcolor="#10abba"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#132F40; font-family:Arial, sans-serif; font-size:15px"><![endif]-->
												<div
													style="text-decoration:none;display:inline-block;color:#fff;background-color:#10abba;border-radius:50px;-webkit-border-radius:50px;-moz-border-radius:50px;width:auto; width:auto;;border-top:1px solid #10abba;border-right:1px solid #10abba;border-bottom:1px solid #10abba;border-left:1px solid #10abba;padding-top:5px;padding-bottom:5px;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
													<span
														style="padding-left:20px;padding-right:20px;font-size:15px;display:inline-block;"><span
															style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
																...
																style="font-size: 15px; line-height: 30px;"><strong><span
																		...
																		style="line-height: 30px; font-size: 15px;">iFCast Job Portal
											...
											<div
												...
												<div
													...
													<p
														...
														<strong>iFCast Consultancy </strong></p>
													<br />
													<p
														style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
														iFieldSmart Technologies LLP</p>
													<p
														style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
														3rd Floor, Shree Ganesh Classic, Gangapur Rd, Anandvalli,
														Nashik, Maharashtra 422013</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<!--[if (!mso)&(!IE)]><!-->
																		...
																		<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 0px; padding-left: 10px;"
																			valign="top"><a
																				...
																				target="_blank"><img alt="Facebook"
																					height="32"
																					src="<?php echo base_url(); ?>assets/images/email/facebook2x.png"
																		...
																		<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 0px; padding-left: 10px;"
																			valign="top"><a href="https://twitter.com/"
																				target="_blank"><img alt="Twitter"
																					height="32"
																					src="<?php echo base_url(); ?>assets/images/email/twitter2x.png"
																					style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
																		...
																		<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 0px; padding-left: 10px;"
																			valign="top"><a
																				...
																				target="_blank"><img alt="Instagram"
																					height="32"
																					src="<?php echo base_url(); ?>assets/images/email/instagram2x.png"
																					style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
