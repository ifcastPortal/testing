              ...
              <div class="job-title-and-info">
                <div class="title">
                  ...
                  <div class="title-body">
                    <h4><?php echo $jobDetails->job_title; ?> </h4>
                    <div class="info">
					  <span class="company"><a href="#"><i data-feather="briefcase"></i><?php echo $jobDetails->company_name; ?></a></span>
				...
				?>
					<a class="save" href="#"><i data-feather="heart"></i>Save Job</a>
					<button type="button" class="apply" name="apply" id="btn_apply" onclick="applyJob('<?php echo $jobDetails->jobpost_id; ?>','apply');">Apply</button> 
				<?php 
					}
				?>
                    ...
                    <div class="information-and-share">
                      <div class="job-summary">
                        ...
                        <li><span>Posted on:</span> <?php echo date('d-M-Y', strtotime($jobDetails->jobPostDate)); ?></li>
                          ...
                          <li><span>Experience:</span> <?php echo $jobDetails->min_experience; ?>-<?php echo $jobDetails->max_experience; ?> Years</h5></li>
                          ...
                          <li><span>Salary:</span> <?php
								...
								<p class="d-inline">&#8377;<?php echo $jobDetails->min_ctc; ?> - &#8377;<?php echo $jobDetails->max_ctc; ?></p>  
								<?php 
								}
							?></li>
          ...
          <div class="col">
            <div class="call-to-action-2">
              <div class="call-to-action-content">
                ...
                <p>Add resume or post a job. Get a quick solution.</p>
              </div>
