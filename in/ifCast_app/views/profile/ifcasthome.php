...
<!-- Search and Filter [VINBO] CHANGES IN THIS SECTION -->
      ...
      <div class="col">
        <div class="searchAndFilter-block">
          <div class="searchAndFilter">
            <form action="<?php echo base_url(); ?>profile/joblistpage_searchform" class="search-form" method="POST">
              <input type="text" placeholder="Enter Keywords" name="jobtitle" id="jobtitle" required>
              ...
              <select class="" id="subCity_name" name="subCity_name"  style="border-bottom:2px solid rgba(0, 0, 0, 0.08); width:calc(33% - 78px); border-left:none;border-right:none;border-top:none;cursor:pointer;height:6rem;width:28.5rem;z-index:1000;font:15px roboto,sans-serif;">
                <option selected>Preffered Location</option> 
                <?php
              ...
              <button class="button primary-bg" type="submit"><i class="fas fa-search"></i>Search Job</button>
            </form>
    ...
    <div class="row">
      <div class="col">
        <ul class="nav nav-tabs job-tab" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" id="feature-tab" data-toggle="tab" href="#feature" role="tab" aria-controls="feature" aria-selected="false">Feature Job</a>
          </li>
                          ...
                          <div class="body">
                            <div class="content">
                              <h4>
                                ...
                                <a href="jobs/details/<?php echo $jobs->jobpost_id; ?>"><?php echo $jobtitle_trim; ?></a>
                              </h4>
                              <div class="info">
                                <?php
              ...
              ?>
                    ...
                    <div class="col-lg-6">
                      <div class="job-list half-grid">
                        ...
                        <div class="body">
                          <div class="content">
                            <h4><a href="jobs/details/<?php echo $jobs->jobpost_id; ?>"><?php echo $jobs->job_title; ?></a></h4>
                            <div class="info">
    ...
    <div class="row">
      <div class="col-xl-5 col-lg-6">
        <div class="newsletter-wrap">
          ...
          <form action="<?= base_url() ?>profile/newslettersubscriber" method="POST" enctype="multipart/form-data" class="newsletter-form form-inline">
            <div class="form-group">
              <input type="text" id="newsletter_emailid" name="to" class="form-control" placeholder="Email address..." required>
            </div>
...
*/
  ...
  $(document).ready(function() {
    $('#city_id').on('change', function() {
      ...
      $.ajax({
        url: "profile/loadsubCities/"+city_id,
