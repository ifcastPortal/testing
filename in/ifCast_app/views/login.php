		...
		<div class="row">
			<div class="col-md-6">
				<div class="breadcrumb-area">
					<h1>Login as Dreamer (Job Seeker)</h1>
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a>At iFCast a Job Seeker is 'Dreamer'</a></li>
						</ol>
					</nav>
				</div>
			</div>
				...
				<div class="padding-top-60 padding-bottom-60 access-form">
					...
					<form name="frm_login" id="frm_login" method="post" action="" onSubmit="return validateForm();">
						...
						<label for="" style="color:#445578; font-weight:550; font-size:13px; line-height:18px;">Email id / Username</label>
							<input type="email" class="form-control" id="username" placeholder="Enter Email Id" name="username">
...
<div class="modal fade" id="forgotpasswordModal" tabindex="-1" role="dialog" aria-labelledby="modelHeader" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form id="forgotpassword_modelForm" name="forgotpassword_modelForm" action="<?php echo site_url('login/reset_password'); ?>" method="post">
				<div class="row">
	...
	function validateForm() {
		...
		$.ajax({
			...
			success: function(data) {
				switch (data) {
					case 0:
						window.location.href = base_url + "profile/verify_otp";  //profile/ifcasthome
						break;
					case 1:
