		...
		<div class="job-list">
			...
			<div class="body">
				<div class="content">
					...
					?>
                        ...
                        <h4><a href="guestuser/details/<?php echo $jobs->jobpost_id; ?>" target="_blank" title="<?php echo $jobs->job_title; ?>"><?php echo $jobtitle_trim; ?> </a></h4>
					<div class="info">
				...
				<div class="more">
					<div class="buttons">
					  <a href="guestuser/details/<?php echo $jobs->jobpost_id; ?>" class="button" >View details</a>
					  <a href="guestuser/details/<?php echo $jobs->jobpost_id; ?>" class="favourite"><i data-feather="heart"></i></a>
					</div>
			...
			?>
              ...
              <p class="m-4">Want to find more specific job?</p>
                        <a class="m-4 button primary-bg p-4" href="<?php echo base_url(); ?>guestuser/joblistpage" style="color:white;">Try Advance Search</a>
