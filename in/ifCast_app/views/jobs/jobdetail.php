...
<div class="alice-bg padding-top-60 section-padding-bottom">
      ...
      <div class="col">
        <div class="job-listing-details">
          <div class="job-title-and-info">
            <div class="title">
              ...
              <div class="title-body">
                ...
                <div class="info">
                  ...
                  <span class="company">
                    <a href="#"><i data-feather="briefcase"></i><?php echo $company_name_trim; ?></a>
                  </span>

                  <span class="office-location">
                    <a href="#"><i data-feather="map-pin"></i>
                      <?php
                      $y = 0;
                  ...
                  <span class="job-type temporary text-capitalize">
                    <a href="#">
                      <i data-feather="clock"></i>
                      <?php echo $jobDetails->min_experience; ?>-<?php echo $jobDetails->max_experience; ?> Years
                    </a>
                  </span>
                </div>
              </div>
            ...
            <!-- [VINBO] change all the <div class="button"></div> -->

            <div class="buttons">
              <div class="row">
                <div class="col-lg-12 col-mgd-12 col-sm-12 text-center">


                  <?php if ($job_saved === 1 || $job_saved === '1') { ?>
                    <button type="button" disabled id="changeText" class="btn btn-primary" style="cursor:pointer; padding:15px 30px; margin-right:10px;font-weight:600; font-family:'poppins',sans-serif;font-size:1.4rem;">Saved</button>
                  <?php } else { ?>
                    <button type="button" id="changeText" class="btn btn-outline-primary" onclick="saveJob('<?php echo $jobDetails->jobpost_id; ?>','save');" style="cursor:pointer; padding:15px 30px; margin-right:10px;font-weight:600; font-family:'poppins',sans-serif;font-size:1.4rem;"><i data-feather="heart" style="margin:0px 7px  0px 0px;width:18px;"></i>Save Job</button>
                  <?php  } ?>

                  <?php if ($job_applied === 0 || $job_applied === '0') { ?>
                    <button type="button" disabled id="text" class="btn btn-success" style="cursor:pointer;padding:15px 30px; margin-right:10px;font-weight:600; font-family:'poppins',sans-serif;font-size:1.4rem;">Applied</button>
                    <!-- background-color:#10abba;color:#fff; -->
                  <?php  } else { ?>
                    <button type="button" id="text" class="btn btn-outline-success" onclick="applyJob('<?php echo $jobDetails->jobpost_id; ?>','apply'); " style="cursor:pointer;padding:15px 30px; margin-right:10px;font-weight:600; font-family:'poppins',sans-serif;font-size:1.4rem;">Apply Job</button>
                  <?php  } ?>

                  <!-- <span class="loader" id="loader_apply">&nbsp;
                <strong style="font-size:18px; color:green;"> Applied </strong> &nbsp;
              <span class="loader" id="loader_apply">&nbsp;
      ...
      <div class="row">
        <div class="col">
          <div class="section-header section-header-2 section-header-with-right-content">
            <h2>Simillar Jobs</h2>
            <a href="<?php echo base_url(); ?>profile/joblistpage" class="header-right">+ Browse All Jobs</a>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col">
          <div class="call-to-action-2">
            <div class="call-to-action-content">
              ...
              <p>Know about the courses and get skilled.</p>
            </div>
  ...
  <script>
    ...
    //[VINBO] edit THIS FUNCTION

    function applyJob(job_id, action = "apply") {

      var msg = "Your have successfully applied this job.";

      if (action == "apply")
        msg = "Job successfully applied.";
    ...
    function saveJob(job_id, action = "save") {
      var msg = "Your have successfully saved this job.";
