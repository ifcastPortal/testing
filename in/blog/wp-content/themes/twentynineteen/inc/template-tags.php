...
if ( ! function_exists( 'twentynineteen_post_thumbnail' ) ) :
	...
	function twentynineteen_post_thumbnail() {
		...
		if ( is_singular() ) :
			...
			<figure class="ifc-box-shadow-3 ifc-post-thumbnail " style="height:320px;overflow:hidden;" >
			...
			?>
<!-- 100px -->
		<figure class="ifc-post-thumbnail " style="">
			<a class="ifc-post-thumbnail-inner" href="<?php the_permalink(); ?>" aria-hidden="true" tabindex="-1">
				<?php the_post_thumbnail( 'post-thumbnail' );
				// echo "This is NON S Figure Post-Thumbnail";
				?>
			</a>
		</figure>
